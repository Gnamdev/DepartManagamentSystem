...
import { getIdByUser, signUp, updatingEmp } from "../service/EmployeeService";
...
const UpdateEmployee = () => {
  ...
  const handelChange = (event) => {
    ...
    setData({ ...data, [event.target.name]: value }); // Update the state with the new value
    console.log(data);
  };
          ...
          >
            ...
            >
              <div class="text-2xl font-bold mb-2 text-[#1e0e4b] text-center">
                <span class="text-[#7747ff]">Update Form </span>
              </div>
